...
% Last Modified by GUIDE v2.5 02-Jun-2024 14:48:54
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
textString = get(handles.edit1,'String');% 獲取当前编辑框中的字符串
number = str2double(textString);% 将字符串转换为数值
number = -number;% 改變數值的符号
...
% handles    structure with handles and user data (see GUIDATA)
textString = get(handles.edit1,'String'); %獲取可編輯文本框的字符串，並保存在textString中
textString = strcat(textString,'x');%橫向連接字符串
set(handles.edit1,'String',textString);%顯示在可編輯文本框
guidata(hObject, handles);
...
textString = strrep(textString, 'x', '*');
...
% handles    structure with handles and user data (see GUIDATA)
textString = get(handles.edit1,'String'); %獲取可編輯文本框的字符串，並保存在textString中
textString = strcat(textString,'sin(');%橫向連接字符串
set(handles.edit1,'String',textString);%顯示在可編輯文本框
guidata(hObject, handles);

% --- Executes on button press in pushbutton_cos.
function pushbutton_cos_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_cos (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
textString = get(handles.edit1,'String'); %獲取可編輯文本框的字符串，並保存在textString中
textString = strcat(textString,'cos(');%橫向連接字符串
set(handles.edit1,'String',textString);%顯示在可編輯文本框
guidata(hObject, handles);

% --- Executes on button press in pushbutton_tan.
function pushbutton_tan_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_tan (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
textString = get(handles.edit1,'String'); %獲取可編輯文本框的字符串，並保存在textString中
textString = strcat(textString,'tan(');%橫向連接字符串
set(handles.edit1,'String',textString);%顯示在可編輯文本框
guidata(hObject, handles);

% --- Executes on button press in pushbutton_cot.
function pushbutton_cot_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_cot (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
textString = get(handles.edit1,'String'); %獲取可編輯文本框的字符串，並保存在textString中
textString = strcat(textString,'cot(');%橫向連接字符串
set(handles.edit1,'String',textString);%顯示在可編輯文本框
guidata(hObject, handles);
...
% hObject    handle to pushbutton_fraction (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
inputString = get(handles.edit1, 'String');
decimalValue = str2double(inputString);
...
if isnan(decimalValue)
    ...
    if contains(inputString, '/')
        ...
        if length(parts) == 2
            numerator = str2double(strtrim(parts{1}));
            denominator = str2double(strtrim(parts{2}));
            ...
            if isnan(numerator) || isnan(denominator) || denominator == 0
                ...
                set(handles.edit1, 'String', num2str(decimalValue));
            end
    ...
    % 輸入小數時
    [numerator, denominator] = rat(decimalValue);
    % 顯示轉換後的分數
    fractionString = sprintf('%d/%d', numerator, denominator);
    set(handles.edit1, 'String', fractionString);
end
